  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" link " target="_blank">
        <img src="../assets/img/logoetalase.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Etalase Talisya</span>
      </a>
    </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="../assets/img/fotoku.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Pesan baru</span> matsuoka48
                        </h6>
    ...
    <div class="container-fluid py-4">
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1">Selamat Berkerja</h5>
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1">Cepat dalam meproses data</h5>
      ...
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    ...
                    <h5 class="text-white mb-1">Selalu Semangat</h5>
                    <p>Jangan lupa berdoa sebelum memulai</p>
                  </div>
                </div>
              </div>
                ...
                <tbody>
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="../assets/img/bodycare.png" alt="Country flag">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">Kategori:</p>
                          <h6 class="text-sm mb-0">Bodycare</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="../assets/img/haircare.png" alt="Country flag">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">Kategori:</p>
                          <h6 class="text-sm mb-0">Haircare</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="../assets/img/makeup.png" alt="Country flag">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">Kategori:</p>
                          <h6 class="text-sm mb-0">Makeup</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="../assets/img/skincare.png" alt="Country flag">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">Kategori:</p>
                          <h6 class="text-sm mb-0">Skincare</h6>
                        </div>
                      </div>
                    </td>
                    <td>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="Link Web" class="font-weight-bold" target="_blank">Etalase Talisya</a>
                Shop
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="link website" class="nav-link text-muted" target="_blank">Instagram</a>
                </li>
                <li class="nav-item">
                  <a href="linkwebsite" class="nav-link text-muted" target="_blank">Whatsapp</a>
                </li>
                <li class="nav-item">
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <a class="btn bg-gradient-dark w-100" href="linkapk">Download Mobile APk</a>
        <a class="btn btn-outline-dark w-100" href="linkweb">Website</a>
        <div class="w-100 text-center">
          <a class="github-button" href="https://github.com/creativetimofficial/argon-dashboard" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star creativetimofficial/argon-dashboard on GitHub">Star</a>
          <h6 class="mt-3">Media sosial kami</h6>
